# China AI Knowledge Base Hub

> Sources: Compiled from linked China and shared wiki pages
> Raw: See linked pages
> Updated: 2026-05-11

## Overview

This is the entry page for a China-specific agent knowledge base. It points to pages that primarily describe China's interests, instruments, strategies, governance style, and simulation roles, while also linking outward to shared pages that China agents should read when they need a wider geopolitical frame.

## China-Specific Core

Canonical policy anchor for the `AI+` layer:

- `../../raw/reg-documents/2025-08-21-ai-plus-initiative-gov-cn.md`

- [Chinese AI Governance Style and Agenda](chinese-ai-governance-style-and-agenda.md)
- [Chinese AI Strategic Interests](chinese-ai-strategic-interests.md)
...
- [China Agent Evolution Workflow](china-agent-evolution-workflow.md)
- [China Propaganda Generation Template](china-propaganda-generation-template.md)

## Shared Pages China Agents Should Also Read
